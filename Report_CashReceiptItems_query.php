<?php
    ...
    function refreshRecords() {
        ...
        $query = "select * from view_cash_receipt_item_search where PRODUCT LIKE \"%%\"; ";
...
function filterRecords($PRODUCT) 
    {
            echo '<div class="panel panel-default">';  
            echo '<table class="table table-striped">';
            echo '<thead>';
        ...
        //========================================================================================================
        //below code generated with workbench plugin for php under tools > utilities
        $query = "select * from view_cash_receipt_item_search where PRODUCT LIKE \"%$PRODUCT%\"; ";
