...
function profitTillDate()
    {
        ...
        $query = "SELECT * FROM view_profit_monthly_stationery;";        
...
function profitDateFilter($thisDate1,$thisDate2)
    {
        ...
        if ($thisDate1 == '' && $thisDate2 == ''){
            $query = "call STATIONERYPROFITMONTHLY(NULL,NULL)";}
        if ($thisDate1 != '' && $thisDate2 == ''){
            $query = "call STATIONERYPROFITMONTHLY('" . $thisDate1 . "',NULL)";}
        if ($thisDate1 != '' && $thisDate2 != ''){
        $query = "call STATIONERYPROFITMONTHLY('" . $thisDate1 . "','" . $thisDate2 . "')";}
