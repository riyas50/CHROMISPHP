...
function profitTillDate()
    {
        ...
        $query = "SELECT * FROM view_profit_monthly_Internet;";        
...
function profitDateFilter($thisDate1,$thisDate2)
    {
        ...
        if ($thisDate1 == '' && $thisDate2 == ''){
            $query = "call INTERNETPROFITMONTHLY(NULL,NULL)";}
        if ($thisDate1 != '' && $thisDate2 == ''){
            $query = "call INTERNETPROFITMONTHLY('" . $thisDate1 . "',NULL)";}
        if ($thisDate1 != '' && $thisDate2 != ''){
        $query = "call INTERNETPROFITMONTHLY('" . $thisDate1 . "','" . $thisDate2 . "')";}
