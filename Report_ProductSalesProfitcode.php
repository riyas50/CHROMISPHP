...
function profitTillDate()
    {
        ...
        $query ="SELECT * from tilldateprofititemwise";
...
function profitDateFilter($thisDate1,$thisDate2)
    {
        ...
        if ($thisDate1 == '' && $thisDate2 == ''){
            $query = "call SALESPROFITDATE(NULL,NULL)";}
        if ($thisDate1 != '' && $thisDate2 == ''){
            $query = "call SALESPROFITDATE('" . $thisDate1 . "',NULL)";}
        if ($thisDate1 != '' && $thisDate2 != ''){
        $query = "call SALESPROFITDATE('" . $thisDate1 . "','" . $thisDate2 . "')";}
