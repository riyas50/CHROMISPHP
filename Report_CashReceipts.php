...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="site__title mega text-center">Cash Receipts Search</h1>
    </span>
    </div>
  </header>
...
<form action="Report_CashReceipts.php" method="post" enctype="multipart/form-data">
 <div class="row">
...
<?php
    ...
    include('Report_CashReceipts_query.php');
