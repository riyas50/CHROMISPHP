...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="site__title mega text-center">Customer Items Last/Max Billed</h1>
    </span>
    </div>
  </header>
...
<form action="Report_CustomerItems_price.php" method="post" enctype="multipart/form-data">
 <div class="row">
 ...
 <div class="input-group">
    ...
    <input type="text" class="form-control" name="customer" id="inlineFormInputGroup" placeholder="Customer..." required>
    <input type="hidden" id="CustID" name="CustID" value="" class="form-control">
    <div id="display" class="list-group"></div>
    <input type="text" class="form-control" name="items" id="productInput" placeholder="product..." required>
...
<?php
    ...
    include('Report_CustomerItems_price_query.php');
