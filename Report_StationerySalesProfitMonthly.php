...
<html lang="en">
  <head>
    <?php
        ...
        include('Report_StationerySalesProfitcodeMonthly.php');
        putLinks();
    ...
    ?>
   <title>Stationery Sales:Monthly Profit - Chromis BackOffice</title>
  </head>
  <body>
...
<header class="site__header island">
  <div class="wrap">
   ...
   <h1 class="site__title mega text-center">Stationery Sales : Profit</h1>
   <h2 class="site__title mega text-center">Monthly</h2>
   </span>
  </div>
  </header>

<form action="Report_StationerySalesProfitMonthly.php" method="post" enctype="multipart/form-data" >
 <div class="row">
